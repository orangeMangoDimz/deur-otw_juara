...
import dummyImg from "../../public/images/product/sofa.png"
                        ...
                        <table className="min-w-full text-left text-sm font-light">
                            ...
                            <tbody>
                                <tr className="border-b dark:border-neutral-500">
                                    ...
                                    <td className="whitespace-nowrap px-6 py-4"><img src={dummyImg} alt="sofa" /></td>
                                    <td className="whitespace-nowrap px-6 py-4">Sofa</td>
                                    ...
                                    <td className="whitespace-nowrap"><DeleteBtn /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
